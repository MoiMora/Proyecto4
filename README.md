...
Las funciones que se utilizan en el codigo son:
...
* `modulador_I(bits_Rx, fc, MPP)`: Convierte la señal de información (arreglo de `bits_Tx_I`) en una señal modulada_I bajo un esquema **QPSK**.
* `modulador_Q(bits_Rx, fc, MPP)`: Convierte la señal de información (arreglo de `bits_Tx_Q`) en una señal modulada_I bajo un esquema **QPSK**.
